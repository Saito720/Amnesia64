...
namespace luxnet {
static const uint32_t ProtocolVersion = 14;
...
enum Packet : uint8_t { Hello=1, MapBegin, MapChunk, MapEnd, Ready, Reject,
    ...
    InventoryGrant=31, InventoryRemove=32, EntityDefinition=40, SameMapTeleport=41, EntityRemoved=42, PlayerIdentities=43 };
