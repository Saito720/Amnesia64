...
HUD text, icons, and the shared game menus retain retail's widescreen proportions.
Narrower windows fit the authored layout without squeezing it; the layout stays
centered, and full-screen fades and message backgrounds cover the entire window.
