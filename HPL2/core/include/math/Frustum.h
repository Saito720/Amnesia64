...
namespace hpl {
	...
	public:
		...
		inline ml::float4x4 GetProjectionMat() const { return cMath::ToFloat4x4(m_mtxProj);}
		inline ml::float4x4 GetViewMat() const { return cMath::ToFloat4x4(m_mtxView);}
		inline ml::float4x4 GetViewProjectionMat() const { return cMath::ToFloat4x4(m_mtxViewProj);}
